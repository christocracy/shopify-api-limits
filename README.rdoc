...
The following methods don't require a scope (:shop/:global).  If the <b>:global</b> scope has fewer calls available than the local scope,
the methods will operate upon the :global scope; otherwise, values will be returned based upon the :shop scope.   
