...
== Solution
Hack <tt>ActiveResource::Connection</tt> to introduce a new <tt>attr_reader :response</tt> and capture the returned <tt>HTTPResponse</tt> from <tt>net/http</tt> instance from the <tt>#handle_response</tt> method.
